...
UObject* UVoxelHeightmapFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
...
TSharedPtr<FVoxelHeightmap> UVoxelHeightmapFactory::Import(const FString& Path)
{
	...
	const TSharedRef<FVoxelHeightmap> Data = MakeShared<FVoxelHeightmap>();
		...
		[
			...
			[
				...
				[
					...
					.SlotPadding(FEditorAppStyle::GetMargin("StandardDialog.SlotPadding"))
					...
					[
						...
						.ContentPadding(FEditorAppStyle::GetMargin("StandardDialog.ContentPadding"))
						.OnClicked_Lambda([=]
						{
						...
						.ButtonStyle(FEditorAppStyle::Get(), "FlatButton.Success")
						.TextStyle(FEditorAppStyle::Get(), "FlatButton.DefaultTextStyle")
					]
					...
					[
						...
						.ButtonStyle(FEditorAppStyle::Get(), "FlatButton.Default")
						.TextStyle(FEditorAppStyle::Get(), "FlatButton.DefaultTextStyle")
					]
				]
			]
