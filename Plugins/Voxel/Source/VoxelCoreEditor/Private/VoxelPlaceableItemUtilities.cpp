...
struct FVoxelPlaceableItemUtilitiesInfo
{
	...
	void Register()
	{
		...
		const FPlacementCategoryInfo PlacementCategoryInfo(VOXEL_LOCTEXT("Voxel"), FSlateIcon(FVoxelEditorStyle::GetStyleSetName(), "VoxelIcon"), VoxelPlaceableItemHandle, TEXT("PMVoxel"), 25);
