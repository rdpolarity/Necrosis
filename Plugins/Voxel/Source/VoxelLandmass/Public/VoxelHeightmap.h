...
public:
	...
	TSharedRef<FVoxelRDGExternalBuffer> GetHeights_RenderThread() const;
...
private:
	...
	mutable TSharedPtr<FVoxelRDGExternalBuffer> Heights_RenderThread;
};
