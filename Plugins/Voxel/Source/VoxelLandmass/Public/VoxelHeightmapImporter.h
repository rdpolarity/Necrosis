...
class VOXELLANDMASS_API FVoxelHeightmapImporter
{
public:
	const FString Path;
	FString Error;
...
class VOXELLANDMASS_API FVoxelHeightmapImporter_PNG : public FVoxelHeightmapImporter
{
public:
...
class VOXELLANDMASS_API FVoxelHeightmapImporter_Raw : public FVoxelHeightmapImporter
{
public:
	using FVoxelHeightmapImporter::FVoxelHeightmapImporter;
