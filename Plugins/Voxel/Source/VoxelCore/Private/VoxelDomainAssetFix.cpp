...
#include "Projects/Private/PluginManager.h"
#undef final
#undef private
...
{
	TSharedRef<FPlugin>& VoxelPlugin = static_cast<FPluginManager&>(IPluginManager::Get()).AllPlugins.FindChecked(VOXEL_PLUGIN_NAME) UE_501_ONLY([0]);
