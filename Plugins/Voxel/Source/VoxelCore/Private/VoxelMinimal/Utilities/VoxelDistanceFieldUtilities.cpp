...
void FVoxelUtilities::JumpFlood2D(const FIntPoint& Size, TArrayView<FIntPoint> InOutClosestPosition)
{
	...
	if (bSourceIsTemp)
	{
		...
		Memcpy(InOutClosestPosition, Temp);
	}
}